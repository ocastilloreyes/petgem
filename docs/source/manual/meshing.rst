...
For example, ``examples/fm`` declares four regions with tags 1-4,
...
``examples/fm/geometry/mesh.geo``, a coarse far-field size, a fine size
...
.. code-block:: bash
   ...
   gmsh -3 examples/fm/geometry/mesh.geo -o examples/fm/outputs/mesh.msh
