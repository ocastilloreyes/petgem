/*********************************************************************
* im_model_smooth.geo -- CANDIDATE M1: smooth graded transition.
*
...
SY = -4000;
h_roi = 40;  h_an = 25;  h_near = 40;  h_far = 5000;    // h_far 10000 -> 5000
...
Field[1].Thickness=1500;                                 // 400 -> 1500
...
Field[2].Thickness=800;                                  // 200 -> 800
Field[3]=MathEval; Field[3].F=Sprintf("%g + 0.22*sqrt(x^2 + y^2 + z^2)", h_near);          // 0.32 -> 0.22
Field[4]=MathEval; Field[4].F=Sprintf("%g + 0.22*sqrt(x^2 + (y-(%g))^2 + z^2)", h_near, SY); // 0.32 -> 0.22
