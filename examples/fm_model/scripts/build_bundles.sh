...
#       bash examples/fm_model/scripts/build_bundles.sh [order]
#
# Produces examples/fm_model/outputs/input.h5 (+ a throwaway preprocess params
...
echo "=== fm_model bundle ready: $C/outputs/input.h5 ==="
