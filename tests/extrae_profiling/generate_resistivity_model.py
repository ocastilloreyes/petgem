...
# ------------------------------------------------------------------------------
nord = sys.argv[1]
input_mesh_filename = f"tests/extrae_profiling/mesh_p{nord}.msh"
output_mesh_filename = f"tests/extrae_profiling/resistivity_model_p{nord}.h5"
input_receivers_filename = "tests/extrae_profiling/receivers.txt"
output_receivers_filename = "tests/extrae_profiling/receivers.h5"
numDimensions = 3
